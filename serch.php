            ...
            session_start();
             ...
             if(isset($_SESSION['city'])   ||  isset($_SESSION['type']))
             {
                    ...
                    if($_SESSION['city'] === "ALL" && !($_SESSION['type']==="ALL"))
                    {
                        //echo " hi 1";
                        $type=$_SESSION['type'];
                        $sql= "SELECT * FROM product  where subcategory ='$type'";
                                 ...
                                 echo '  
                                      <tr>  
                                           <td>  
                                              ...
                                              <a href="SimulatedOutput.php?value='.$r['pid'].'">
                                              <img src="image/"'.$r['image'].' " name=$value height="200" title="hi" width="250"  class="img-thumnail"  /> </a> 
                    ...
                    else if(!($_SESSION['city'] === "ALL" || $_SESSION['type'] === "ALL"))
                    {
                      //  echo " hi 2";
                        $type=$_SESSION['type'];
                        $city=$_SESSION['city'];
                        $sql= "SELECT * FROM product join image using (PROD_ID) where category='$type' ";
                        ECHO "HI";
                                 ...
                                 echo '  
                                      <tr>  
                                           <td>  
                                            ...
                                            <a href="SimulatedOutput.php?value='.$r['PROD_ID'].'">   
                                              <img src="image/'.$r['image'].'"  height="200" width="250" title="hi" value="1" class="img-thumnail"  /></a>
                                                    <script>
                                                    function imageTitle(title){
                                                     alert(title);
                                                     console.log(title);
